...
lrTabBar::lrTabBar(QWidget *parent)
    : QTabBar(parent)
{
...
void lrTabBar::mousePressEvent(QMouseEvent *event)
{
...
void lrTabBar::mouseMoveEvent(QMouseEvent *event)
{
...
void lrTabBar::mouseReleaseEvent(QMouseEvent *event)
{
